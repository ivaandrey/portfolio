...
+ **Leadership & Delivery**: Technical Leadership, End-to-End Project Ownership, Production Deployment
...
[*Tracking with Online Adaptive Classifiers*](https://www.youtube.com/watch?v=7SY7zlmDr0M) — real-time object tracking that formulates the problem as classification, using **AdaBoost** with **online-selected Haar-like features** to adapt to appearance changes from lighting, occlusion, and motion blur.
